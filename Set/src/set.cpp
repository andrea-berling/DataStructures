...
/*
    template<typename T>
    set_iterator<T>::set_iterator(): keyOnly::hash_iterator<T>()
    {}

    template<typename T>
    set_iterator<T>::set_iterator(Set<T>* s): keyOnly::hash_iterator<T>(&(s->elements))
    {}

    template<typename T>
    set_iterator<T>::set_iterator(const set_iterator& it): keyOnly::hash_iterator<T>(it)
    {}

    template<typename T>
    set_iterator<T>::set_iterator(const keyOnly::hash_iterator<T>& it)
    {
        *this = it;
    }
*/
